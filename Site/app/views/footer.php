...
<script>
    $(function(){
        ...
        $('.adiciona_item').on('click',function(e){
        ...
        $('.adiciona_peça').on('click',function(e){
            ...
            if(peca && qtd_peca){
                if(parseInt(qtd_peca)>parseInt(estoque)){
                    ...
                    $('#lista_pecas').append('<hr><div class="form-row"><div class="form-group col-md-6"><label>Peça adicionada</label><input class="form-control" value="'+txt_peca+'" readonly></div><div class="form-group col-md-3"><label>Qtd adicionada</label><input class="form-control" value="'+qtd_peca+'" readonly></div><div class="form-group col-md-3"><label>Estoque Atual</label><input class="form-control" value="'+estoque_atual+'" readonly><input name="peca[]" type="hidden" value="'+peca+'"><input name="qtd_peca[]" type="hidden" value="'+qtd_peca+'"></div><div class="form-group col-md-2 text-center"></div>');
                }
            }
            else{
