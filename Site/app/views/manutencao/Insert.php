                ...
                <fieldset class="form-group border rounded p-5">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input class="form-control" type="text" name="itens[]"  placeholder="Descrição do item">
                        </div>
                        <div class="form-group col-md-4">
                            <label for="valor_item_1">Valor</label>
                            <input class="form-control" type="text"  name="valor_item[]" placeholder="Digite o valor deste item">
                        </div>
